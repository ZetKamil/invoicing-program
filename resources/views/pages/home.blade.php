...
@section('content')
    ...
    <div class="container">
      <div class="hero-content">
        ...
        <p class="hero-sub" id="hs">
          Ultrasnelle websites met een ingebouwd Smart Quote-systeem voor Vlaamse transporteurs. Uw dispatcher ontvangt
          enkel nog volledige, gestructureerde offerteaanvragen.
        </p>
  ...
  <section id="problems">
    <div class="container">
      ...
      <p class="section-sub">We zijn geen gewoon webbureau. We kennen het verschil tussen ADR, koeltransport en
      ...
      <div class="problems-grid">
        <div class="prob-card">
          ...
          <p class="prob-text">Klanten bellen zonder afmetingen, gewicht of postcodes. Uw dispatcher verliest dagelijks
            uren aan nutteloze heen-en-weerberichten en incomplete mails.</p>
        </div>
        <div class="prob-card">
          <div class="prob-icon">📄</div>
          <div class="prob-title">E-facturering verplicht vanaf 2026</div>
          <p class="prob-text">De wetgeving klopt aan de deur. Grote ERP-systemen zoals SAP zijn onbetaalbaar voor KMO's.
            Wij bieden een schaalbaar alternatief dat meegroeit met uw bedrijf.</p>
        </div>
        <div class="prob-card">
          <div class="prob-icon">🕸️</div>
          <div class="prob-title">Verouderde website, nul B2B-leads</div>
          <p class="prob-text">90% van de lokale transporteurs heeft een digitale visitekaart die geen enkel kwalitatief
            contact oplevert. Dat is gemiste omzet, elke dag opnieuw.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="services">
    <div class="container">
      ...
      <p class="section-sub">Elk pakket bevat hosting, frontend én een Mini-CRM dashboard. Eenmalig + kleine maandelijkse
        abonnementskost.</p>
      <div class="packages-grid">
        <!-- START -->
        <div class="pkg-card">
          <div class="pkg-tier">Webdesign: Basic Setup (Eenmalig)</div>
          <div class="pkg-price"><sup>€</sup>850</div>
          <div class="pkg-recur">Strictly static SEO one-pager<br>+ € 49,00 / maand voor onderhoud</div>
          ...
          <button class="pkg-btn" onclick="selectPackage('Basic Setup')">Kies Start</button>
        </div>
        <!-- PRO -->
        <div class="pkg-card popular">
          <div class="popular-label">Meest gekozen</div>
          <div class="pkg-tier">Webdesign: Pro Transport Edition (Eenmalig)</div>
          <div class="pkg-price"><sup>€</sup>2.450</div>
          <div class="pkg-recur">Full website + Smart Quote System + Master-Digit Basic CRM onboarding</div>
          <div class="pkg-divider"></div>
          <ul class="pkg-features">
          ...
          <button class="pkg-btn" onclick="selectPackage('Pro Transport Edition')">Kies Pro Transport</button>
        </div>
        <!-- ENTERPRISE -->
        <div class="pkg-card">
          <div class="pkg-tier" style="font-size: 1.1rem; line-height: 1.2;">Master-Digit SaaS & Add-ons (Licenties)</div>
          <div class="pkg-price"><sup>€</sup>600</div>
          <div class="pkg-recur">/ jaarbasis (Prepaid)</div>
          <div class="pkg-divider"></div>
          <ul class="pkg-features">
            <li><span class="feat-check">✓</span> Core Engine recurring access</li>
            <li><span class="feat-check">✓</span> Premium Peppol API & Automated UBL 2.1 e-Invoicing Module: € 1.188,00 /
              jaarbasis (Prepaid)</li>
          ...
          <button class="pkg-btn" onclick="selectPackage('SaaS Licenties')">Vraag offerte aan</button>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="steps-grid">
        <div class="step">
          ...
          <p class="step-text">Onze AI analyseert uw huidige website op snelheid, UX en conversie. U ontvangt een concreet
            rapport binnen 24 uur.</p>
        </div>
        <div class="step">
          <div class="step-num">2</div>
          <div class="step-title">Intakegesprek</div>
          <p class="step-text">30 minuten. Geen verkoopspraatjes. We luisteren naar uw bedrijf en stellen het juiste
            pakket voor.</p>
        </div>
        <div class="step">
        ...
        <div class="step">
          ...
          <p class="step-text">Dag 7: uw site staat live. Leads stromen gestructureerd binnen. Upsell-modules groeien mee
            op uw tempo.</p>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="testi-grid">
        <div class="testi-card">
          <div class="stars">★★★★★</div>
          <p class="testi-quote">Onze dispatcher ontvangt nu alleen nog volledige offerteaanvragen. Het scheelt ons
            minstens 2 uur per dag aan telefoontjes. Eindelijk rust op de planning.</p>
        ...
        <div class="testi-card">
          <div class="stars">★★★★★</div>
          <p class="testi-quote">In 7 dagen een professionele site én een systeem waarmee mijn team leads opvolgt. Ik had
            niet verwacht dat dit zo snel en vlot kon verlopen. Sterk werk.</p>
          <div class="testi-author">
        ...
        <div class="testi-card">
          <div class="stars">★★★★★</div>
          <p class="testi-quote">We verloren klanten aan concurrenten met een betere online aanwezigheid. Nu scoren we als
            eerste in Google voor koeltransport in de regio. Meer kan ik niet vragen.</p>
          <div class="testi-author">
    ...
    <div class="container">
      ...
      <div class="audit-wrap">
        <div class="audit-features">
          <div class="af-item">
            ...
            <div>
              ...
              <p class="af-text">We meten laadtijden och Core Web Vitals. Een trage site verliest 40% van bezoekers al in
                de eerste 3 seconden.</p>
            </div>
          </div>
          <div class="af-item">
            <div class="af-icon">🎯</div>
            <div>
              ...
              <p class="af-text">Zijn uw formulieren zo opgebouwd dat ze kwalitatieve leads binnenhalen? Wij checken elk
                contactpunt.</p>
            </div>
          </div>
          <div class="af-item">
            ...
            <div>
              ...
              <p class="af-text">Scoort u voor "transportbedrijf Roeselare" of "koeltransport West-Vlaanderen"? Wij
                analyseren uw zichtbaarheid.</p>
            </div>
          </div>
          <div class="af-item">
            <div class="af-icon">📊</div>
            <div>
              ...
              <p class="af-text">Wie staat er boven u in Google, en waarom? U ontvangt concrete aanbevelingen om hen in te
                halen.</p>
            </div>
          </div>
        </div>
        <div class="audit-form-box">
          ...
          <p>Vul uw gegevens in en ontvang binnen 24 uur een gepersonaliseerd rapport — volledig gratis, zonder
            verplichtingen.</p>
          <div class="aform" id="audit-form-container">
            ...
            <button class="btn-primary" style="justify-content:center;width:100%" onclick="submitAudit(event)">🔍
              Analyseer mijn website</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="smartquote">
    <div class="container">
      ...
      <p class="section-sub">Ons digitaal formulier dwingt klanten alle gegevens in te vullen vóór ze kunnen versturen. Uw
        dispatcher werkt direct met volledige dossiers.</p>
      <div class="quote-wrap">
        <div class="quote-info">
          <div class="qi-item">
            ...
            <div>
              ...
              <p class="qi-text">ADR, koeltransport, groupage, container — de klant kiest, het systeem past het formulier
                aan.</p>
            </div>
          </div>
          <div class="qi-item">
            ...
            <div>
              ...
              <p class="qi-text">Afmetingen, gewicht, laad- en losadres worden verplicht ingevoerd. Geen vage aanvragen
                meer.</p>
            </div>
          </div>
          <div class="qi-item">
            ...
            <div>
              ...
              <p class="qi-text">Elke aanvraag belandt gestructureerd in uw Mini-CRM dashboard. Opvolging in één
                oogopslag.</p>
            </div>
          </div>
          <div class="qi-item">
            ...
            <div>
              ...
              <p class="qi-text">Uw team ontvangt onmiddellijk een melding met alle gegevens. Reageer sneller dan de
                concurrent.</p>
            </div>
          </div>
        </div>
        <div class="quote-form-box">
          ...
          <div class="qform" id="quote-form-container">
            ...
            <button class="btn-primary" style="justify-content:center;width:100%" onclick="submitQuote(event)">📤 Offerte
              aanvragen</button>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="about-grid">
        <div class="about-card">
          ...
          <p class="ac-bio">We werken uitsluitend voor transport-, spedities en logistieke bedrijven in Flandria. Geen
            kappers, geen restaurants — enkel KMO's die vracht verplaatsen. Die focus vertaalt zich in software die de
            sector écht begrijpt.</p>
          <div class="tech-tags">
        ...
        <div class="about-body">
          <p>TransDigit Master is opgericht met één doel: de administratieve chaos in Vlaamse transportbedrijven
            elimineren. We combineren diepgaande sectorkennis met moderne webontwikkeling.</p>
          <p>Ons model is uniek: we stappen binnen als webbouwer, maar leveren een Mini-CRM dat uitgroeit tot een
            volwaardig ERP-systeem voor uw bedrijf — gefinancierd vanuit uw eigen groei, zonder grote investeringen
            vooraf.</p>
          <ul class="value-list">
      ...
      <div class="blog-grid">
        <div class="blog-card">
          <div class="blog-thumb" style="padding: 0;">
            <img src="{{ asset('images/blog/blog_einvoicing.png') }}" alt="E-facturering 2026"
          ...
          <div class="blog-body">
            ...
            <p class="blog-excerpt">De federale overheid voert verplichte e-facturering in voor B2B. Wij leggen uit wat
              het betekent voor KMO-transporteurs och hoe u zich voorbereidt.</p>
            <span class="blog-read">Lees verder →</span>
          </div>
        </div>
        <div class="blog-card">
          <div class="blog-thumb" style="padding: 0;">
            <img src="{{ asset('images/blog/blog_dispatcher.png') }}" alt="Smart Quote Formulier"
              style="width:100%; height:100%; object-fit:cover;" />
          </div>
          <div class="blog-body">
            ...
            <p class="blog-excerpt">Door klanten te verplichten alle gegevens in te vullen vóór het versturen, stoppen de
              incomplete aanvragen definitief. Zo werkt het in de praktijk.</p>
            <span class="blog-read">Lees verder →</span>
          </div>
        </div>
        <div class="blog-card">
          <div class="blog-thumb" style="padding: 0;">
            <img src="{{ asset('images/blog/blog_seo.png') }}" alt="Lokale SEO"
              style="width:100%; height:100%; object-fit:cover;" />
          </div>
          <div class="blog-body">
            ...
            <p class="blog-excerpt">Lokale zoektermen in de logistiek zijn goud waard. Ontdek welke concrete stappen u
              vandaag al kunt zetten voor betere Google-resultaten.</p>
            <span class="blog-read">Lees verder →</span>
          </div>
        </div>
      </div>
  ...
  <section id="contact">
    <div class="container">
      ...
      <p class="section-sub">Geen verkoopspraatjes. Een eerlijk gesprek over uw situatie — och of wij de juiste partner
        zijn voor uw bedrijf.</p>
