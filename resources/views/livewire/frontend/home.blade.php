            ...
            <div class="packages-grid">
                ...
                <div class="pkg-card">
                    ...
                    <button class="pkg-btn"
                        onclick="document.getElementById('contact').scrollIntoView({behavior:'smooth'})">Kies
                        Start</button>
                </div>
                <!-- PRO -->
                <div class="pkg-card popular">
                    ...
                    <button class="pkg-btn"
                        onclick="document.getElementById('contact').scrollIntoView({behavior:'smooth'})">Kies Pro
                        Transport</button>
                </div>
                <!-- ENTERPRISE -->
                <div class="pkg-card">
                    <div class="pkg-tier">Enterprise</div>
                    <div class="pkg-price"><sup>€</sup>1.950<span style="font-size:22px;color:var(--muted)">+</span>
                    </div>
                    ...
                    <button class="pkg-btn"
                        onclick="document.getElementById('contact').scrollIntoView({behavior:'smooth'})">Vraag offerte
                        aan</button>
                </div>
            </div>
        </div>
