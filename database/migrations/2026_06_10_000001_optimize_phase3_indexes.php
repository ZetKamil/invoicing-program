...
/**
 * Phase 3 Performance Hardening â€” Missing Index Audit
 *
 ...
 *
 *  1. quote_items    â€” FK column quote_id has no explicit B-Tree index.
 *                      SQLite does NOT auto-create indexes for FK constraints.
 *                      Every $quote->items() call scans the full quote_items table.
 *
 *  2. invoice_items  â€” Same FK index gap as quote_items for invoice_id.
 *
 *  3. invoices       â€” Missing composite [bedrijf_id, due_date] index.
 ...
 *
 *  4. communications â€” No indexes at all on a table that stores polymorphic
...
return new class extends Migration
{
    ...
    {
        // 1. quote_items â€” explicit FK index on quote_id
        ...
        // 2. invoice_items â€” explicit FK index on invoice_id
        ...
        // 3. invoices â€” composite index on [bedrijf_id, due_date]
        ...
        // 4. communications â€” composite index on [bedrijf_id, related_type, related_id]
